...
EMSCRIPTEN_KEEPALIVE mpc_ptr c_t () { return (mpc_ptr)malloc(sizeof(mpc_t)); }
EMSCRIPTEN_KEEPALIVE void c_t_free (mpc_ptr p1) { free(p1); }

EMSCRIPTEN_KEEPALIVE int  c_add       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_add(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_add_fr    (mpc_ptr p1, mpc_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_add_fr(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_add_si    (mpc_ptr p1, mpc_srcptr p2, long int p3, mpc_rnd_t p4) { return mpc_add_si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_add_ui    (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_add_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_sub       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_sub(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_sub_fr    (mpc_ptr p1, mpc_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_sub_fr(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_fr_sub    (mpc_ptr p1, mpfr_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_fr_sub(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_sub_ui    (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_sub_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_ui_ui_sub (mpc_ptr p1, unsigned long int p2, unsigned long int p3, mpc_srcptr p4, mpc_rnd_t p5) { return mpc_ui_ui_sub(p1, p2, p3, p4, p5); }
EMSCRIPTEN_KEEPALIVE int  c_mul       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_mul(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_fr    (mpc_ptr p1, mpc_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_mul_fr(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_ui    (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_mul_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_si    (mpc_ptr p1, mpc_srcptr p2, long int p3, mpc_rnd_t p4) { return mpc_mul_si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_i     (mpc_ptr p1, mpc_srcptr p2, int p3, mpc_rnd_t p4) { return mpc_mul_i(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_sqr       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_sqr(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_div       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_div(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_pow(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow_fr    (mpc_ptr p1, mpc_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_pow_fr(p1, p2, p3, p4); }
// EMSCRIPTEN_KEEPALIVE int  c_pow_ld    (mpc_ptr p1, mpc_srcptr p2, long double p3, mpc_rnd_t p4) { return mpc_pow_ld(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow_d     (mpc_ptr p1, mpc_srcptr p2, double p3, mpc_rnd_t p4) { return mpc_pow_d(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow_si    (mpc_ptr p1, mpc_srcptr p2, long p3, mpc_rnd_t p4) { return mpc_pow_si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow_ui    (mpc_ptr p1, mpc_srcptr p2, unsigned long p3, mpc_rnd_t p4) { return mpc_pow_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_pow_z     (mpc_ptr p1, mpc_srcptr p2, mpz_srcptr p3, mpc_rnd_t p4) { return mpc_pow_z(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_div_fr    (mpc_ptr p1, mpc_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_div_fr(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_fr_div    (mpc_ptr p1, mpfr_srcptr p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_fr_div(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_div_ui    (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_div_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_ui_div    (mpc_ptr p1, unsigned long int p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_ui_div(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_div_2ui   (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_div_2ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_2ui   (mpc_ptr p1, mpc_srcptr p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_mul_2ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_div_2si   (mpc_ptr p1, mpc_srcptr p2, long int p3, mpc_rnd_t p4) { return mpc_div_2si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_mul_2si   (mpc_ptr p1, mpc_srcptr p2, long int p3, mpc_rnd_t p4) { return mpc_mul_2si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_conj      (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_conj(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_neg       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_neg(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_sum       (mpc_ptr p1, const mpc_ptr * p2, unsigned long p3, mpc_rnd_t p4) { return mpc_sum(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_dot       (mpc_ptr p1, const mpc_ptr * p2, const mpc_ptr *p3, unsigned long p4, mpc_rnd_t p5) { return mpc_dot(p1, p2, p3, p4, p5); }
EMSCRIPTEN_KEEPALIVE int  c_norm      (mpfr_ptr p1, mpc_srcptr p2, mpfr_rnd_t p3) { return mpc_norm(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_abs       (mpfr_ptr p1, mpc_srcptr p2, mpfr_rnd_t p3) { return mpc_abs(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_sqrt      (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_sqrt(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_set(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_d     (mpc_ptr p1, double p2, mpc_rnd_t p3) { return mpc_set_d(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_d_d   (mpc_ptr p1, double p2, double p3, mpc_rnd_t p4) { return mpc_set_d_d(p1, p2, p3, p4); }
// EMSCRIPTEN_KEEPALIVE int  c_set_ld    (mpc_ptr p1, long double p2, mpc_rnd_t p3) { return mpc_set_ld(p1, p2, p3); }
// EMSCRIPTEN_KEEPALIVE int  c_set_ld_ld (mpc_ptr p1, long double p2, long double p3, mpc_rnd_t p4) { return mpc_set_ld_ld(p1, p2, p3, p4); }
// EMSCRIPTEN_KEEPALIVE int  c_set_f     (mpc_ptr p1, mpf_srcptr p2, mpc_rnd_t p3) { return mpc_set_f(p1, p2, p3); }
// EMSCRIPTEN_KEEPALIVE int  c_set_f_f   (mpc_ptr p1, mpf_srcptr p2, mpf_srcptr p3, mpc_rnd_t p4) { return mpc_set_f_f(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_set_fr    (mpc_ptr p1, mpfr_srcptr p2, mpc_rnd_t p3) { return mpc_set_fr(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_fr_fr (mpc_ptr p1, mpfr_srcptr p2, mpfr_srcptr p3, mpc_rnd_t p4) { return mpc_set_fr_fr(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_set_q     (mpc_ptr p1, mpq_srcptr p2, mpc_rnd_t p3) { return mpc_set_q(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_q_q   (mpc_ptr p1, mpq_srcptr p2, mpq_srcptr p3, mpc_rnd_t p4) { return mpc_set_q_q(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_set_si    (mpc_ptr p1, long int p2, mpc_rnd_t p3) { return mpc_set_si(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_si_si (mpc_ptr p1, long int p2, long int p3, mpc_rnd_t p4) { return mpc_set_si_si(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_set_ui    (mpc_ptr p1, unsigned long int p2, mpc_rnd_t p3) { return mpc_set_ui(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_ui_ui (mpc_ptr p1, unsigned long int p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_set_ui_ui(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE int  c_set_z     (mpc_ptr p1, mpz_srcptr p2, mpc_rnd_t p3) { return mpc_set_z(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_set_z_z   (mpc_ptr p1, mpz_srcptr p2, mpz_srcptr p3, mpc_rnd_t p4) { return mpc_set_z_z(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE void c_swap      (mpc_ptr p1, mpc_ptr p2) { mpc_swap(p1, p2); }
EMSCRIPTEN_KEEPALIVE int  c_fma       (mpc_ptr p1, mpc_srcptr p2, mpc_srcptr p3, mpc_srcptr p4, mpc_rnd_t p5) { return mpc_fma(p1, p2, p3, p4, p5); }

EMSCRIPTEN_KEEPALIVE void c_set_nan   (mpc_ptr p1) { mpc_set_nan(p1); }

EMSCRIPTEN_KEEPALIVE int  c_real        (mpfr_ptr p1, mpc_srcptr p2, mpfr_rnd_t p3) { return mpc_real(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_imag        (mpfr_ptr p1, mpc_srcptr p2, mpfr_rnd_t p3) { return mpc_imag(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_arg         (mpfr_ptr p1, mpc_srcptr p2, mpfr_rnd_t p3) { return mpc_arg(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_proj        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_proj(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_cmp         (mpc_srcptr p1, mpc_srcptr p2) { return mpc_cmp(p1, p2); }
EMSCRIPTEN_KEEPALIVE int  c_cmp_si_si   (mpc_srcptr p1, long int p2, long int p3) { return mpc_cmp_si_si(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_cmp_abs     (mpc_srcptr p1, mpc_srcptr p2) { return mpc_cmp_abs(p1, p2); }
EMSCRIPTEN_KEEPALIVE int  c_exp         (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_exp(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_log         (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_log(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_log10       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_log10(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_sin         (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_sin(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_cos         (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_cos(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_sin_cos     (mpc_ptr p1, mpc_ptr p2, mpc_srcptr p3, mpc_rnd_t p4, mpc_rnd_t p5) { return mpc_sin_cos(p1, p2, p3, p4, p5); }
EMSCRIPTEN_KEEPALIVE int  c_tan         (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_tan(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_sinh        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_sinh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_cosh        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_cosh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_tanh        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_tanh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_asin        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_asin(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_acos        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_acos(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_atan        (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_atan(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_asinh       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_asinh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_acosh       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_acosh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_atanh       (mpc_ptr p1, mpc_srcptr p2, mpc_rnd_t p3) { return mpc_atanh(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE int  c_rootofunity (mpc_ptr p1, unsigned long int p2, unsigned long int p3, mpc_rnd_t p4) { return mpc_rootofunity(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE void c_clear       (mpc_ptr p1) { mpc_clear(p1); }
EMSCRIPTEN_KEEPALIVE int  c_urandom     (mpc_ptr p1, gmp_randstate_t p2) { return mpc_urandom(p1, p2); }
EMSCRIPTEN_KEEPALIVE void c_init2       (mpc_ptr p1, mpfr_prec_t p2) { mpc_init2(p1, p2); }
EMSCRIPTEN_KEEPALIVE void c_init3       (mpc_ptr p1, mpfr_prec_t p2, mpfr_prec_t p3) { mpc_init3(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE mpfr_prec_t c_get_prec (mpc_srcptr p1) { return mpc_get_prec(p1); }
EMSCRIPTEN_KEEPALIVE void c_get_prec2   (mpfr_prec_t *p1, mpfr_prec_t *p2, mpc_srcptr p3) { mpc_get_prec2(p1, p2, p3); }
EMSCRIPTEN_KEEPALIVE void c_set_prec    (mpc_ptr p1, mpfr_prec_t p2) { mpc_set_prec(p1, p2); }
EMSCRIPTEN_KEEPALIVE const char * c_get_version () { return mpc_get_version(); }

EMSCRIPTEN_KEEPALIVE int  c_strtoc      (mpc_ptr p1, const char *p2, char **p3, int p4, mpc_rnd_t p5) { return mpc_strtoc(p1, p2, p3, p4, p5); }
EMSCRIPTEN_KEEPALIVE int  c_set_str     (mpc_ptr p1, const char *p2, int p3, mpc_rnd_t p4) { return mpc_set_str(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE char* c_get_str   (int p1, size_t p2, mpc_srcptr p3, mpc_rnd_t p4) { return mpc_get_str(p1, p2, p3, p4); }
EMSCRIPTEN_KEEPALIVE void c_free_str    (char * p1) { return mpc_free_str(p1); }
// EMSCRIPTEN_KEEPALIVE int  c_set_sj      (mpc_ptr p1, intmax_t p2, mpc_rnd_t p3) { return mpc_set_sj(p1, p2, p3); }
// EMSCRIPTEN_KEEPALIVE int  c_set_uj      (mpc_ptr p1, uintmax_t p2,  mpc_rnd_t p3) { return mpc_set_uj(p1, p2, p3); }
// EMSCRIPTEN_KEEPALIVE int  c_set_sj_sj   (mpc_ptr p1, intmax_t p2, intmax_t p3, mpc_rnd_t p4) { return mpc_set_sj_sj(p1, p2, p3, p4); }
// EMSCRIPTEN_KEEPALIVE int  c_set_uj_uj   (mpc_ptr p1, uintmax_t p2, uintmax_t p3, mpc_rnd_t p4) { return mpc_set_uj_uj(p1, p2, p3, p4); }
